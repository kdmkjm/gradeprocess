		...
		<div style="margin-bottom: 1%;">
			<div>
				<h1 style="font-size: x-large;">
					<a href="student_score_list.do"><img src="image/sist_logo.png" alt="logo"
		...
		<div class="panel-group">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form role="form" action="stpwmodify.do" method="post">
						...
						<div class="form-group">
							<label for="employeeId">수강생ID:</label> <input type="text"  value="${all.student_id}"
						...
						<div class="form-group">
							<label for="name">이름:</label> <input type="text" value="${all.st_name}"

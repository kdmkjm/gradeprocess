					...
					<tbody>
						<c:forEach var="i" items="${list}">
							<tr>
								...
								<td>${i.st_total}</td>
								<td><c:choose>
										<c:when test="${i.schedule == 0}">
									       강의예정
									    </c:when>
										<c:when test="${i.schedule == 1}">
									        강의진행
									    </c:when>
										<c:otherwise>
									        강의종료
					...
					<div class="panel-body">
						<div class="text-box-bg">
							<div class="form-group" id="box02">
								과정명 :<span id="ss_cou_name">정보보안</span><br> 
								과목명 :<span id="ss_sub_name">Java</span><br> 
								과목 시작 :<span id="ss_sub_start_date">2016-04-05</span><br> 
								과목 종료 :<span id="ss_sub_end_date">2016-05-05</span><br> 
								수강인원 :<span id="ss_st_total">4</span><br>
							</div>
						</div>

		...
		<div style="margin-bottom: 1%;">
			<div>
				<h1 style="font-size: x-large;">
					<a href="inst_schedule_all.do"><img src="image/sist_logo.png" alt="logo"
		...
		<div class="panel-group">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form role="form" action="instpwmodify.do" method="post">
						...
						<div class="form-group">
							<label for="employeeId">강사ID:</label> <input type="text"  value="${all.instructor_id}"
								class="form-control" id="instructorid" name="instructorid"
								placeholder="직원번호 (수정시 사용)" required="required" readonly="readonly">
						</div>
						
						
						<div class="form-group">
							<label for="name">이름:</label> <input type="text" value="${all.inst_name}"
								class="form-control" id="name" name="name"
								placeholder="이름 (10자 이내)" maxlength="10" readonly="readonly">
						</div>

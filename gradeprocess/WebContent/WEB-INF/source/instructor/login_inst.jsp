...
<style>
.panel-login>.panel-heading a#teacher-form-link {
	color: #fff;/*활성화 상태*/
}
    ...
    <div class="col-md-6 col-md-offset-3">
      <div class="panel panel-login">
          ...
          <div class="row">
            ...
            <div class="col-xs-4 tabs">
              <a href="login_inst.do" class="active" id="teacher-form-link"><div class="teacher">강사</div></a>
            </div>
            <div class="col-xs-4 tabs">
              <a href="login_admin.do" class="" id="admin-form-link"><div class="admin">관리자</div></a>
            </div>
          </div>
        </div>

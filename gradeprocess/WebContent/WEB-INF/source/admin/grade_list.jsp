...
$(document).ready(function(){
	...
	$(".btn_info").on("click",function(){
		$("#hidden_form .hidden_course_id").val($(this).parents("tr").children().eq(0).text());
		$("#hidden_form .hidden_course_name").val($(this).parents("tr").children().eq(1).text());
		$("#hidden_form .hidden_course_start_date").val($(this).parents("tr").children().eq(2).text());
		$("#hidden_form .hidden_course_end_date").val($(this).parents("tr").children().eq(3).text());
	});
              ...
              <form method="post" class="">
                ...
                <div class="col-md-2.5 col-sm-2.5 col-xs-2.5 form-group pull-right">
      				<select class="form-control top_search_select" name="skey" id="skey">
      					<option value="courseall">전체</option>
					...
					<tbody>
	                  <!-- 
						<tr>
							...
							<td>
								<div class="btn-group">
										<a href="grade_course.do" class="btn btn-default btn-xs">조회</a>
								</div>
							</td>
						</tr> -->
						...
						<c:forEach var="s" items="${list}">
							<tr>
								...
								<td>${s.sub_count}</td>
								<td>${s.class_total}</td>
								<td><form action="grade_course.do" method="post" id="hidden_form">
								<div class="btn-group" id="btn-group"><button type="submit" class="btn btn-default btn-xs btn_info">조회</button></div>
							<input type="hidden" class="hidden_course_id" name="course_id">
							<input type="hidden" class="hidden_course_name" name="course_name">
							<input type="hidden" class="hidden_course_start_date" name="course_start_date">
							<input type="hidden" class="hidden_course_end_date" name="course_end_date"></form></td>
							</tr>
						</c:forEach>
					   </tbody>
				      </table>

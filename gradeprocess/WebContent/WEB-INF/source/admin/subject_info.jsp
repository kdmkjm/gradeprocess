        ...
        <div class="right_col" role="main">
           <!--+++++++++++++++++ panel-header ++++++++++++++++++-->
            <div class="page-title">
                ...
                <div class="col-md-2.5 col-sm-2.5 col-xs-2.5 form-group pull-right">
      				<select class="form-control top_search_select" name="skey" id="skey">
      					<option value="all">전체</option>
							<option value="subjectName_id">과목명ID</option>
			 ...
			 <tr>
			 	<td>${s.subjectName_id}</td>
			 	<td>${s.sub_name}</td>
			 	<td><div class="btn-group"><button type="button" class="btn btn-default btn-xs modify">수정</button>
			 	<button type="button" class="btn btn-default btn-xs delete" ${(s.delCheck == 0)?"":"disabled=\"disabled\""}>삭제</button></div></td>
			 </tr>
			 </c:forEach>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title-text">과목명 정보 추가</h4>
					</div>
						<!-- form -->
						<form action="subNameAdd.do" method="post">
						<!-- Modal body -->
						<div class="modal-body">
								<div class="form-group">
									<label for="addName">과목명</label><input type="text"
		...
		<div id="updateModal" class="modal fade" role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h4 class="modal-title-text">과목명 정보 수정</h4>
					</div>
						<!-- form -->
						<form action="subNameModify.do" method="post">
						<!-- Modal body -->
						<div class="modal-body">
								<div class="form-group">
									<label for="updateNid">과목명ID</label><input type="text"
										class="form-control" id="updateNid" name="updateNid" required
										value="sub_name_001" maxlength="20" readonly> <span
										class="help-block"></span>
								</div>

								<div class="form-group">
									<label for="updateName">과목명</label><input type="text"
										class="form-control" id="updateName" name="updateName" required
										value="Java" maxlength="20" placeholder="20자 이내">
								</div>
		...
		<div id="deleteModal" class="modal fade" role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h4 class="modal-title-text">과목명 정보 삭제</h4>
					</div>
					<!-- form -->
					<form action="subNameRemove.do" method="post">
						<!-- Modal body -->
						<div class="modal-body">
							<div class="form-group">
								<label for="deleteNid">과목명ID</label><input type="text"
									class="form-control" id="deleteNid" name="deleteNid" required
									value="sub_name_001" maxlength="20" readonly>
							</div>

							<div class="form-group">
								<label for="deleteName">과목명</label><input type="text"
									class="form-control" id="deleteName" name="deleteName" required
									value="Java" maxlength="20" readonly>
							</div>
